...
def save_data_to_files(self):
    pickle.dump(self.features, open("comp_features_dict.p", "wb"), protocol=2)
    pickle.dump(self.tags, open("comp_tags.p", "wb"), protocol=2)
    pickle.dump(self.word_to_freq_tags_dict, open("comp_freq_tags.p", "wb"), protocol=2)
    np.save('comp_opt_v', self.v_vec)
